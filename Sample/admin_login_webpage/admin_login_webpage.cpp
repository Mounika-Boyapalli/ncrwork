...

{
	...
	do {
		...
		else
		{
			...
			char fath[128];
			cout << "<html>";
			cout << "<center><button onclick=\"tableShow()\" id=\"det\">Get Details<button></center>";
			cout << "<center><p><a href=\"http://localhost/entermarks.html\"><font size=10>Enter marks</font></a></p></center>";
			cout << "<center><p id=\"mydet\" hidden>Details Table</p></center>";
			cout << "<script type=\"text/javascript\">function tableHide(){document.getElementById(\"table\").style.display=\"none\";}function tableShow(){document.getElementById(\"table\").style.display=\"block\";document.getElementById(\"mydet\").style.display=\"block\";}</script>";
			cout << "<body><style>table, th, td { border: 1px solid black; width: 100%; padding: 8px; }</style><table id=\"table\" style=\"width:100%\" hidden><tr><th>Name</th><th>Email</th><th>LoginID</th> <th>Address</th><th>Father Name</th></tr>";
...

{
	...
	do {
		...
		else
		{
			...
			{
				string newq = "select * from reg_table";
				checkSQL1(newq);
