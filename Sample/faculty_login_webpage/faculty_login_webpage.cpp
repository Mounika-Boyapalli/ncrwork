	...
	do {
		...
		else
		{
			...
			else
			{
				...
				cout << "<center><p><a href=\"http://localhost/enter_marks.html\"><font size=10>Enter Marks</font></a></p></center>";
				cout << "<center><p><a href=\"http://localhost/edit_marks.html\"><font size=10>Edit Marks</font></a></p></center>";
				cout << "</html>";
			}
		}
...
int main(int argc, char **argv)
{
	try {
		...
		string SQLQuery1 = "select * from faculty_login where password='";
