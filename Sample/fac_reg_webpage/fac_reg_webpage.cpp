...
int main()
{
	...
	form_iterator id = cgi.getElement("fac_id");
	form_iterator pass = cgi.getElement("pwd");
	form_iterator fath = cgi.getElement("faname");
	form_iterator add = cgi.getElement("addr");

	//char SQLQuery1[2000] = "SELECT * FROM reg_table;";

	string SQLQuery1 = "INSERT INTO faculty_data VALUES('";
	...
	SQLQuery1 = SQLQuery1 + **add;

	SQLQuery1 = SQLQuery1 + "','";

	SQLQuery1 = SQLQuery1 + **fath;
	...
	string SQLQuery2 = "INSERT INTO faculty_login VALUES('";

	SQLQuery2 = SQLQuery2 + **id;

	SQLQuery2 = SQLQuery2 + "','";

	SQLQuery2 = SQLQuery2 + **pass;
